...
export default function Header(){
    ...
    return (
        <div className="flex flex-col justify-center items-center text-center space-y-7 bg-gradient-to-b from-white via-white to-blue-200 opacity-100 md:-mx-20 pb-20">
            ...
            <div className="flex items-center md:gap-20 gap-5 md:flex-row flex-col  ">
                <Button title="Start Your Free Trail" variants="primary" onclick={() => router.push("/signup")}/>
                <Button title="See Live Demo" variants="default" onclick={() => router.push("/signup")}/>
            </div>
