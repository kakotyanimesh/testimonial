...
export default function Header(){
    return (
        <div className="flex flex-col justify-center items-center text-center space-y-7">
            <h1 className="flex md:gap-3 gap-1 bg-slate-100 px-5 py-1 rounded-3xl text-blue-500 animate-pulse text-sm transition-all"><span className="font-bold">•</span>Customer Testimonials Reimagined</h1>
            <div className="space-y-2">
                <h1 className="md:text-5xl text-4xl tracking-tight font-bold">Turn Customer <span className="text-blue-500">Voices</span> Into Social Proof</h1>
