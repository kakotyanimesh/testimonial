...
export default function  IndividualPage({params} : {
    ...
    return (
        <div className="md:px-32 bg-slate-100 min-h-screen space-y-10">
            ...
            <div className="flex flex-row  md:gap-4 gap-1 bg-slate-200 rounded-md w-fit px-1 py-1">
                {
            ...
            <div className="space-y-10 text-center flex flex-col justify-center items-center">
                <div className="grid md:grid-cols-3 md:gap-14 gap-3">
                    {
                        dashbaordcardArray.map((d, k) => (
                            <DashboardCard key={k}>
                                <div className="w-72 h-20 text-start">
                                    <h1 className="font-semibold text-lg">{d.title}</h1>
                                    <h1 className="font-semibold text-2xl">{d.number}</h1>
                                </div>
                            </DashboardCard>
                        ))
                    }
                ...
                <div className="flex md:flex-row flex-col gap-5">
                    <DashboardCard>
                        <div className="md:w-[500px] w-[300px] h-56 flex space-y-6 flex-col justify-center items-center ">
                    ...
                    <DashboardCard>
                        <div className="md:w-[500px] w-[300px] h-60 text-center  flex space-y-6 flex-col justify-center items-center ">
